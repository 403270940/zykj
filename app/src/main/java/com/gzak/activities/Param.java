...
public class Param extends ActionBarActivity {
    ...
    private boolean saveAllParam(){
        ...
        if(!ValidationUtil.check("IMEI", IMEI)){
            Toast.makeText(this, "IMEI��ʽ����", Toast.LENGTH_SHORT);
            return false;
        }
        if(!ValidationUtil.check("MAC",MAC)){
            Toast.makeText(this,"MAC��ʽ����",Toast.LENGTH_SHORT);
            return false;
        }
        if(!ValidationUtil.check("IMSI",IMSI)){
            Toast.makeText(this,"IMSI��ʽ����",Toast.LENGTH_SHORT);
            return false;
        }
        if(!ValidationUtil.check("VERSION", VERSION)){
            Toast.makeText(this,"���̸�ʽ����",Toast.LENGTH_SHORT);
            return false;
        }
        if(!ValidationUtil.check("MODEL", MODEL)){
            Toast.makeText(this,"�ͺŸ�ʽ����",Toast.LENGTH_SHORT);
            return false;
        }
        if(!ValidationUtil.check("ANDROIDID",ID)){
            Toast.makeText(this,"ID��ʽ����",Toast.LENGTH_SHORT);
            return false;
        }
        if(!ValidationUtil.check("GPS",GPS)){
            Toast.makeText(this,"GPS��ʽ����",Toast.LENGTH_SHORT);
            return false;
        }
